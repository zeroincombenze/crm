...
* Go to *Sales > Leads*.
* Open a lead.
* Go to *Extra Info > Categorization*.
...
feedback `here <https://github.com/OCA/ crm/issues/new?body=module:%20crm_lead_supplier%0Aversion:%208.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
